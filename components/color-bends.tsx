...
export function ColorBends({
  ...
  const rotationRef = React.useRef<number>(rotation)
  const autoRotateRef = React.useRef<number>(autoRotate)
  const pointerTargetRef = React.useRef<THREE.Vector2>(new THREE.Vector2(0, 0))
  const pointerCurrentRef = React.useRef<THREE.Vector2>(new THREE.Vector2(0, 0))
  const pointerSmoothRef = React.useRef<number>(8)
